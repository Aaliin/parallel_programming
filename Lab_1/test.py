...
if __name__ == "__main__":
    input_file1 = "Lab_1\\matrix1.txt"
    input_file2 = "Lab_1\\matrix2.txt"
    comparison_file = "Lab_1\\matrix_res.txt"
    output_file = "Lab_1\\python_res.txt"
    ...
    with open("Lab_1\\comparison_result.txt", "a") as file:
